...
int main() {
    Student student1(1, "Dezso", "Szabolcs");
    cout<<student1;

    student1.addGrade("roman", 8);
    student1.addGrade("matek", 9.50);
    student1.addGrade("magyar", 8.50);
    student1.addGrade("informatika", 9.75);

    student1.computeAverage();

    cout<<"After the insertion and calculation"<<endl;
    cout<<student1<<endl;

    GraduationDao dao(2023);
    dao.enrollStudents("nevek1.txt");
