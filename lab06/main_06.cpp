...
int main() {
    ...
    Matrix matrix3 = std::move(Matrix(2, 2));

    matrix3.printMatrix();

    matrix3.randomMatrix(10, 15);

    matrix3.printMatrix();

    cout << matrix3.isSquare() << endl;
    cout << matrix2.isSquare() << endl;
    cout << matrix.isSquare() << endl;
    ...
    Matrix matrix7(2, 2);
    cout<<matrix7.getRows()<<" rows and " << matrix7.getCols()<<" columns"<<endl;
    cin>>matrix7;

    cout<<"matrix7:"<<endl;
    matrix7.printMatrix();

    cout<<"matrix7 print with operator overloading:"<<endl;
    cout<<matrix7<<endl;

    int index = 1;
    double* test_rows = matrix7[index];
    int nr = sizeof (test_rows) / sizeof (double);

    cout<<index+1<<".th row of the matrix is:"<<endl;
    for (int i = 0; i <= nr; ++i) {
        cout<<test_rows[i]<<" ";
    }
    cout<<endl;*/
